  ...
  return (
    <main className="flex justify-center py-12 bg-gray-100 dark:bg-[#0b0f1a] min-h-screen">
      <div className="bg-white dark:bg-[#0f172a] dark:border dark:border-gray-700 shadow-xl rounded-2xl p-8 w-full max-w-4xl">
        <h1 className="text-3xl font-extrabold mb-6 text-center">Admin: Editar Publicacion</h1>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div>
            <label className="block mb-2 font-medium">Agregar imagenes</label>
            {(() => {
              const MAX = 10;
              const remaining = Math.max(0, MAX - currentImages.length);
              return remaining > 0 ? (
                <div className="space-y-2">
                  <p className="text-sm text-gray-500">Puedes agregar hasta {remaining} imagen(es) adicionales.</p>
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="px-4 py-2 rounded-xl border" onClick={() => router.push("/admin")}>
              Cancelar
            </button>
            <button
              type="submit"
