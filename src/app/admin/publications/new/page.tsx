  ...
  return (
    <main className="flex justify-center py-12 bg-gray-100 dark:bg-[#0b0f1a] min-h-screen">
      <div className="bg-white dark:bg-[#0f172a] dark:border dark:border-gray-700 shadow-xl rounded-2xl p-8 w-full max-w-3xl">
        <h1 className="text-3xl font-extrabold mb-6 text-center">Admin: Crear Publicacion</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <a href="/admin" className="px-4 py-2 rounded-xl border">
              Cancelar
            </a>
            <button
              type="submit"
              disabled={saving}
              className="btn-accent text-white font-bold py-2 px-6 rounded-xl disabled:opacity-70"
            >
              {saving ? "Creando..." : "Crear publicacion"}
            </button>
          </div>
        </form>
      </div>
